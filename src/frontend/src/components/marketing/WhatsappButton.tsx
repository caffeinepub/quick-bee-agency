...
export default function WhatsappButton({ link, label }: WhatsappButtonProps) {
  const whatsappLink = link || siteConfig.whatsapp.link;
  const buttonLabel = label || 'Chat on WhatsApp';
