...
function from_candid_WhatsAppNotificationStatus_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WhatsAppNotificationStatus): WhatsAppNotificationStatus {
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        attemptResult: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.attemptResult)),
        attemptTime: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.attemptTime))
    };
}
